...
export const initialMockClubs: Club[] = [
    { 
        ...
        funding: { 
            ...
            description: 'Help us buy new nets, balls, and training cones for the upcoming season!', 
            current: 7500, 
            goal: 10000,
            deadline: '2025-12-31'
        }, 
    ...
    { 
        ...
        sport: 'Basketball', 
        logo: 'https://placehold.co/150x150/fca5a5/7f1d1d?text=🦅', 
        tagline: 'Soaring above the competition.', 
        description: 'Downtown\'s premier basketball team.', 
        creatorId: 'creator2', 
        players: [], 
        funding: { 
            title: 'Community Court Renovation', 
            description: 'We are repainting the lines and fixing the hoops at the city park.', 
            current: 15000, 
            goal: 20000,
            deadline: '2025-10-15'
        }, 
        merch: [{ id: 1, name: 'Slam Dunk Hoodie', price: 79.99, image: 'https://placehold.co/300x300/F59E0B/FFFFFF?text=Hoodie' }], 
        posts: [{ id: 3, text: 'Our new merchandise is now available!', image: 'https://placehold.co/600x400/F59E0B/FFFFFF?text=New+Merch', timestamp: new Date('2025-07-21T15:00:00'), likes: 210, comments: [] }] 
    },
    { 
        id: 3, 
        name: 'Valley Vipers', 
        sport: 'Baseball', 
        logo: 'https://placehold.co/150x150/86efac/064e3b?text=🐍', 
        ...
        funding: { 
            title: 'Travel Fund', 
            description: 'Support our trip to the state championships!', 
            current: 4000, 
            goal: 5000,
            deadline: '2025-09-01' 
        }, 
        merch: [], 
        posts: [{ id: 4, text: 'Tough loss, but we\'ll bounce back stronger. See you at the next game.', image: null, timestamp: new Date('2025-07-21T18:00:00'), likes: 76, comments: [] }] 
    },
];